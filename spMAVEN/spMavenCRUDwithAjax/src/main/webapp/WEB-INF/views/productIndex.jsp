	 ...
	 $.ajax({
		 ...
		 success: function(data){
			 for(i=0; i<data.products.length; i++){
				  $("#productTable").append(
					"<tr><td>"+data.products[i].id+"</td><td>"+data.products[i].productName+"</td><td>"+data.products[i].description+"</td><td>"+data.products[i].price+"</td><td>"+data.products[i].qty+"</td><td><span>Edit</span></td></tr>"	  
				  );
			  }
		 }
